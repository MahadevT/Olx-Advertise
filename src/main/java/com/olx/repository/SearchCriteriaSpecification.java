            ...
            switch (dateCondition) {
                case "between":
                    if (fromDate == null || toDate == null || fromDate.isAfter(toDate)) {
                        throw new InvalidDateFormatException(ExceptionConstants.INVALID_FROM_TO_DATES);
                    } else {
                ...
                case "greaterThan":
                    if (fromDate == null) {
                        throw new InvalidDateFormatException(ExceptionConstants.INVALID_FROM_DATE);
                    } else {
                ...
                case "equals":
                    if (onDate == null) {
                        throw new InvalidDateFormatException(ExceptionConstants.INVALID_ON_DATE);
                    } else {
